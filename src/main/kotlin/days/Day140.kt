...
// Day 14 copy from reddit
class Day140 : Day(14) {

    override fun partOne(): Any {
        val aa = mutableListOf<Array<Char>>()
        inputList.forEach { s ->
            aa.add(s.toCharArray().toTypedArray())
        }
        return (solvePart1(aa.toTypedArray()))
    }
    ...
    override fun partTwo(): Any {
        ...
        return (solvePart2(aa.toTypedArray()))
    }
     ...
     */
    fun parse(input: Sequence<String>): Array<Array<Char>> {
     ...
     */
    fun solvePart1(input: Array<Array<Char>>): Any {
     ...
     */
    fun solvePart2(input: Array<Array<Char>>): Any {
